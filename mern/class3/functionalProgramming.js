...
const listClientsIds = () => {
    const clientsIds = clients.map((client, index) => {
        // console.log("🚀 ~ file: functionalProgramming.js:175 ~ clients.map ~ index", index)
        // console.log("🚀 ~ file: functionalProgramming.js:177 ~ clients.map ~ client", client)
        return client.id;
    });
    return clientsIds;
}

const listClientsIdsRefactor = () => {
...
const listClientsIdsSortByTaxNumber = () => {
    ...
    // console.log("🚀 ~ file: functionalProgramming.js:193 ~ listClientsIdsSortByTaxNumber ~ clientSortByRut", clientSortByRut);
...
const sortClientsTotalBalances = () => {
    const bankBalanceSort = clients.map(client => {
        ...
        // console.log(`🚀 ~ ${client.name}`, totalBalance)
        return ({
            ...client,
            totalBalance
        });
    });
    // console.log("🚀 ~ file: functionalProgramming.js:208 ~ bankBalanceSort ~ bankBalanceSort", bankBalanceSort)
    const balanceTotalSort = bankBalanceSort.sort((a,b) => b.totalBalance - a.totalBalance);
    console.log("🚀 ~ file: functionalProgramming.js:210 ~ sortClientsTotalBalances ~ balanceTotalSort", balanceTotalSort);
...
//     })
//         // console.log("🚀 ~ file: functionalProgramming.js:234 ~ totalBank ~ decrece", decrece)
//     } );  
//     return decrece  
//     // return decrece.sort((a, b) => a.totalBalance - b.totalBalance);
//     // console.log("🚀 ~ file: functionalProgramming.js:235 ~ banksRankingByTotalBalance ~ newDecrece", newDecrece)
// }
...
// console.log(listClientsIdsRefactorPro());
